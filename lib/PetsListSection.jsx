                ...
                return (
                  <div key={pet._id.toString()} className="pet-card" data-species={pet.species}>
                    <div className="pet-card-text">
                      ...
                      <p className="pet-age"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cake2" viewBox="0 0 16 16">
                      ...
                      </svg><span>{generateAgeText(pet.birthYear)}</span></p>
                    </div>
